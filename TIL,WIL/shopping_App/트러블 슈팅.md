...
- bottomSheet의 장바구니 추가/제거 아이콘 onTap() 효과의 showCupertinoDialog() 함수가 반복적으로 사용함
- 따로 지역 함수로 빼서 매개변수로 dialog 제목과 내용을 받아 재사용이 가능하게 처리
...
```
- `_showDialog()` 지역함수 지정 후 매개변수로 `String logTitle, String logMessage` 받음
